...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   /* 0: qwerty */
    KEYMAP_TORNADO(
        ...
        KC_LCTL,KC_LGUI,KC_LALT,F(1), KC_SPC, KC_RALT,F(2), F(2), KC_RCTL),
    /* 1: Mouse layer */
    KEYMAP_TORNADO(
        KC_ESC, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_DEL,KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12,  \
        KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS, KC_TRNS,KC_WH_U,KC_MS_U,KC_WH_D,KC_TRNS,KC_TRNS,KC_TRNS,\
        KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_WH_L,KC_MS_L,KC_MS_D,KC_MS_R,KC_WH_R,KC_TRNS,KC_TRNS,\
