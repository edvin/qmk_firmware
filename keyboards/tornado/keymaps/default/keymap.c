...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   /* 0: qwerty */
    ...
    KEYMAP_TORNADO(
        ...
        KC_CAPS,KC_TRNS,KC_VOLD,KC_VOLU,KC_MUTE,KC_TRNS,KC_TRNS,KC_HOME,KC_LEFT,KC_DOWN,KC_RGHT,KC_INS,KC_DEL,KC_TRNS, \
        KC_LSFT,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS, KC_END,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_RSFT, \
        KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,LALT(KC_TAB),    KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS),
};
